...
"SELECT projects.title, pledges.amount FROM pledges JOIN projects ON projects.id = pledges.project_id GROUP BY projects.title HAVING pledges.amount > projects.funding_goal"
end
