...
"SELECT projects.title, pledges.amount FROM pledges INNER JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.funding_goal HAVING pledges.amount > projects.funding_goal"
end
